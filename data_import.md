...
what about `read.csv`…? Answer: never use read.csv
...
``` r
litters_base # going to print the entire data set, more difficult to read
```
...
``` r
write_csv(mlb_df, "./data/mlb_subtanle.csv")
```
